...
import weavermod.powers.CommonPower;
...
public class DefaultCommonPower extends CustomCard {
    ...
    public static final String ID = weavermod.WeaverMod.makeID("DefaultCommonPower");
    ...
    // Go check out DefaultAttackWithVariable and weavermod.variable.DefaultCustomVariable
