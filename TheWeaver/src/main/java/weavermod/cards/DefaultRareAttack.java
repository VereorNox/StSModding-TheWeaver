...
public class DefaultRareAttack extends CustomCard {
    ...
    public static final String ID = weavermod.WeaverMod.makeID("DefaultRareAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = WeaverMod.makePath(WeaverMod.DEFAULT_RARE_ATTACK);
