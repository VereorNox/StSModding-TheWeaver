...
public class DefaultRareSkill extends CustomCard {
    ...
    public static final String ID = weavermod.WeaverMod.makeID("DefaultRareSkill");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = WeaverMod.makePath(WeaverMod.DEFAULT_RARE_SKILL);
