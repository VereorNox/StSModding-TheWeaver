...
public class DefaultOrb extends AbstractOrb {
    ...
    public static final String ORB_ID = WeaverMod.makeID("DefaultOrb");
    ...
    public DefaultOrb() {
        ...
        this.img = ImageMaster.loadImage(WeaverMod.makePath(WeaverMod.DEFAULT_ORB));
