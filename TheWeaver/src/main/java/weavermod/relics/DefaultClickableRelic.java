...
public class DefaultClickableRelic extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    ...
    // ID, images, text.
    public static final String ID = WeaverMod.makeID("DefaultClickableRelic");
    public static final String IMG = WeaverMod.makePath(WeaverMod.DEFAULT_CLICKABLE_RELIC);
    public static final String OUTLINE = WeaverMod.makePath(WeaverMod.DEFAULT_CLICKABLE_RELIC_OUTLINE);
