package weavermod.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import com.megacrit.cardcrawl.ui.panels.EnergyPanel;
import weavermod.cards.AbstractDefaultCard;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    @Override
    public String key() {
        return "theWeaver:SecondMagic"; // This is what you put between "!!" in your card strings to actually display the number.
